...
SERVER=~/Documents/UO_Classes/CIS432/Proj2_Repo/server
...
# Generate a square server topology
#$SERVER localhost 4000 localhost 4001 localhost 4002 localhost 4003 &
#$SERVER localhost 4001 localhost 4000 localhost 4003 &
#$SERVER localhost 4002 localhost 4001 localhost 4003 &
#$SERVER localhost 4003 localhost 4001 localhost 4002 localhost 4000 &
...
# Kill the last server process for testing timeout
